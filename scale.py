...
def scale_pos_neg_unit_sums(v):
    """Рескейл одной строки: положительные делятся на сумму положительных, отрицательные — на модуль суммы отрицательных."""
...
def scale_pos_neg_unit_sums_rows(X: np.ndarray) -> np.ndarray:
    """То же правило, что у `scale_pos_neg_unit_sums`, для каждой строки матрицы (n, k). Векторизация по строкам."""
