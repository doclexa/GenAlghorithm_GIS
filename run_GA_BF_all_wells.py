...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--project-root", default="", help="Корень проекта (по умолчанию — каталог этого скрипта).")
    p.add_argument("--las-dir", default="data/las", help="Каталог с .las.")
    p.add_argument("--out-root", default="outputs/mkm_result", help="Корень вывода (подпапка на скважину).")
